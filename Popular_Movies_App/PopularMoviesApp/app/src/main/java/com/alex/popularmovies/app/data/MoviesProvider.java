...
public class MoviesProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(contentAuthority, MoviesContract.PATH_WEATHER, WEATHER);
        uriMatcher.addURI(contentAuthority, MoviesContract.PATH_WEATHER+"/*", WEATHER_WITH_LOCATION);
        uriMatcher.addURI(contentAuthority, MoviesContract.PATH_WEATHER+"/*/#", WEATHER_WITH_LOCATION_AND_DATE);
        uriMatcher.addURI(contentAuthority, MoviesContract.PATH_LOCATION, LOCATION);
